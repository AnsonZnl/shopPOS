       ...
       <div class="goods-type">
           <el-tabs type="border-card">
               <el-tab-pane label="汉堡">
                   <div class="">
                      <ul class='cookList'>
                        <li v-for="itme in type0Goods">
                            <span class="foodImg"><img :src="itme.goodsImg" width="100%"/></span>
                            <span class="foodName">{{itme.goodsName}}</span>
                            <span class="foodPrice">￥{{itme.price}}元</span>
                        </li>
                      </ul>
                   </div>
               </el-tab-pane>
